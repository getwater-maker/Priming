...
contextBridge.exposeInMainWorld('api', {
  ...
  syncStyles: () => ipcRenderer.invoke('sync-styles'),
  exportChannelStyles: () => ipcRenderer.invoke('export-channel-styles'),  // 🎨 채널 화풍 → ~/.flow-app/channel-styles.json   // ☁ 공용(여러 PC) 스타일 받아오기 + 이 PC 것 올리기
  ...
  deleteImages: (args) => ipcRenderer.invoke('delete-images', args),
  ...
  setTtsServer: (args) => ipcRenderer.invoke('set-tts-server', args),
  testTtsServer: (args) => ipcRenderer.invoke('test-tts-server', args),
  ...
  geminiBatchStatus: () => ipcRenderer.invoke('gemini-batch-status'),
